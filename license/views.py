...
def detectFn(request):
    ...
    pp = 'C:/Users/zol/anaconda3/envs/name_of_environemnt/Lib/site-packages/cv2/'
    nPlateCascade = cv2.CascadeClassifier(pp + 'data/haarcascade_russian_plate_number.xml')
    minArea = 200
    color = (255,0,255)
    ###############################################
